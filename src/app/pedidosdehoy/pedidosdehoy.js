...
export class Pedidosdehoy extends Component {
  state = {
    startDate: new Date()
  };
    ...
    return (
      <div>
        <div className="page-header">
          <h3 className="page-title"> Pedidos de Hoy </h3>
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              <li className="breadcrumb-item"><a href="!#" onClick={event => event.preventDefault()}>Forms</a></li>
              <li className="breadcrumb-item active" aria-current="page">Pedidos de Hoy</li>
            </ol>
          </nav>
        </div>
        <div className="row">
